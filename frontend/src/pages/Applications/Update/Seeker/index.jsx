...
function Index() {
    ...
    async function handleStatusChange(e) {
        ...
        const res = await ajax_or_login(`/applications/seeker/${applicationID}/`, postRequestOptions, navigate);
        ...
        if (!res.ok) {
            ...
            navigate("./")
            setFormData({...FormData, status: "withdrawn"});
            setStatusChange("Application Withdrawn Successfully")
        }
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
          try {
            const response = await ajax_or_login(`/applications/seeker/${applicationID}/`, getRequestOptions, navigate);
                ...
                <form className="flex flex-col justify-center gap-20">
                    ...
                    <div id="CI_sub_form" className="w-full flex flex-col items-center">
                        ...
                        <div className="flex items-center rounded-md bg-background">
                            {/* grid for fields */}
                            <div
                            className="w-full grid grid-rows-3 grid-cols-1 gap-4 px-4 md:px-12 py-8 md:py-12"
                            >
                            {/* wrapper for shelter name */}
                            <div className="w-full">
                                <div>
