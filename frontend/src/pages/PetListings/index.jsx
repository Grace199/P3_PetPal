...
const Index = () => {
    ...
    const query = useMemo(() => ({
        animal: searchParams.get("animal_type") ?? 'Dog',
    ...
    useEffect(() => {
        // Fetch data
        console.log("fetching " + `${query.animal}, ${query.shelter}, ${query.status}, ${query.breed}, ${query.age}, ${query.size}, ${query.colour}, ${query.sex}, ${query.sort}`)
    }, [query]);
        ...
        <>
            <main className="z-0">
                <div className="w-full flex justify-center items-center h-[300px] bg-black relative flex-col">
                    <div className="z-30 group">
                        <button
                            className="z-30 text-background text-8xl font-bold group-hover:text-[#ccc]"
                        >
