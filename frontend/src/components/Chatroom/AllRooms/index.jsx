...
const Index = ({ setChatID }) => {
    ...
    return (
        <>
            < div
                className={`bg-background-secondary max-md:w-screen max-md:fixed w-full md:w-[360px] z-10 h-full flex-col border-r border-black  overflow-y-scroll flex ${open ? 'block' : 'max-md:hidden'}`}
